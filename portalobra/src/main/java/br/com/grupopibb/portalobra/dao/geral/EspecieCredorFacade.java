...
public class EspecieCredorFacade extends AbstractEntityBeans<EspecieCredor, String> {
    ...
    public EspecieCredorFacade() {
        super(EspecieCredor.class, EspecieCredorFacade.class);
    }
